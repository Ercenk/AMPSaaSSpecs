...
import azuremarketplace.saas.SaaSfulfillmentAPIsversion2;
 ...
 */
public class SaaSfulfillmentAPIsversion2Impl extends ServiceClient implements SaaSfulfillmentAPIsversion2 {
    /**
     * The Retrofit service to perform REST calls.
     */
    private SaaSfulfillmentAPIsversion2Service service;

    /**
     * Initializes an instance of SaaSfulfillmentAPIsversion2 client.
     */
    public SaaSfulfillmentAPIsversion2Impl() {
     ...
     */
    public SaaSfulfillmentAPIsversion2Impl(String baseUrl) {
        super(baseUrl);
        initialize();
    }
     ...
     */
    public SaaSfulfillmentAPIsversion2Impl(OkHttpClient.Builder clientBuilder, Retrofit.Builder restBuilder) {
     ...
     * @param restBuilder the builder for building an Retrofit client, bundled with user configurations
     */
    public SaaSfulfillmentAPIsversion2Impl(String baseUrl, OkHttpClient.Builder clientBuilder, Retrofit.Builder restBuilder) {
     ...
     */
    public SaaSfulfillmentAPIsversion2Impl(RestClient restClient) {
        super(restClient);
        initialize();
    }
    ...
    private void initializeService() {
        service = retrofit().create(SaaSfulfillmentAPIsversion2Service.class);
    }

    /**
     * The interface defining all the services for SaaSfulfillmentAPIsversion2 to be
     * used by Retrofit to perform actually REST calls.
     */
    interface SaaSfulfillmentAPIsversion2Service {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 getAllOperations" })
        @GET("")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 resolve" })
        @POST("resolve")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 getSubscription" })
        @GET("{subscriptionId}")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 updateSubscription" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 deleteSubscription" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 listSubscriptionPlans" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 activateSubscription" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 getSubscriptionOperations" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 getSubscriptionOperation" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: azuremarketplace.saas.SaaSfulfillmentAPIsversion2 updateOperation" })
