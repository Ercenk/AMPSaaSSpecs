...
class SaaSfulfillmentAPIsversion2Configuration(Configuration):
    """Configuration for SaaSfulfillmentAPIsversion2
    ...
    def __init__(
        ...
        super(SaaSfulfillmentAPIsversion2Configuration, self).__init__(base_url)

        self.add_user_agent('saasfulfillmentapisversion2/{}'.format(VERSION))


class SaaSfulfillmentAPIsversion2(SDKClient):
    ...
    :vartype config: SaaSfulfillmentAPIsversion2Configuration
    ...
    def __init__(
        ...
        self.config = SaaSfulfillmentAPIsversion2Configuration(base_url)
        super(SaaSfulfillmentAPIsversion2, self).__init__(None, self.config)
