...
/**
 * An interface representing SaaSfulfillmentAPIsversion2Options.
 */
export interface SaaSfulfillmentAPIsversion2Options extends ServiceClientOptions {
  baseUri?: string;
}
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2GetAllOperationsOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2ResolveOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2GetSubscriptionOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2UpdateSubscriptionOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2DeleteSubscriptionOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2ListSubscriptionPlansOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2ActivateSubscriptionOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2GetSubscriptionOperationsOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2GetSubscriptionOperationOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
 ...
 * Optional Parameters.
 */
export interface SaaSfulfillmentAPIsversion2UpdateOperationOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A unique string value for tracking the request from the client, preferably a GUID. If this
   * value isn't provided, one will be generated and provided in the response headers.
   */
