...
namespace AzureMarketplace.SaaS
{
    ...
    /// </summary>
    public partial class SaaSfulfillmentAPIsversion2 : ServiceClient<SaaSfulfillmentAPIsversion2>, ISaaSfulfillmentAPIsversion2
    {
        /// <summary>
        ...
        /// True: will dispose the provided httpClient on calling SaaSfulfillmentAPIsversion2.Dispose(). False: will not dispose provided httpClient</param>
        public SaaSfulfillmentAPIsversion2(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// </param>
        public SaaSfulfillmentAPIsversion2(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public SaaSfulfillmentAPIsversion2(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public SaaSfulfillmentAPIsversion2(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public SaaSfulfillmentAPIsversion2(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
